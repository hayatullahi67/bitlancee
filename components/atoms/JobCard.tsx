...
export default function JobCard({ icon, title, description, price, tags, variant = 'default', titleClassName, descriptionClassName, priceClassName, tagsClassName }: JobCardProps) {
  if (variant === 'findwork') {
    return (
      <div className="rounded-[34px] bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
        ...
        <div className="mb-3 flex items-center justify-between">
          ...
          <span className="text-xs font-bold uppercase text-[#554335]">Fixed</span>
        </div>
