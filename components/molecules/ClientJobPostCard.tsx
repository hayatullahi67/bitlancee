      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        {onEdit && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-full border border-[#EAE7E2] px-5 py-2.5 text-[13px] font-semibold text-[#6b6762] transition-colors hover:bg-[#F3F0EC] hover:text-[#1a1a1a]"
          >
