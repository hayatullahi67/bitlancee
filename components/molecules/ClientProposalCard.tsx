  ...
  return (
    <div className="rounded-[12px] border border-[#EAE7E2] bg-white p-4 shadow-[0_6px_16px_rgba(0,0,0,0.04)]">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="text-[12px] font-semibold text-[#8C4F00]">{rate}</div>
      </div>
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
          <button className="w-full rounded-full border border-[#E0DDD8] px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#6b6762] hover:bg-[#F7F4F0] sm:w-auto">
            Message
          </button>
